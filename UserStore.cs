...
using AspNetCore.Identity.EntityFrameworkCore.Simple;
...
namespace Microsoft.AspNetCore.Identity.EntityFrameworkCore
{
    ...
    public class UserStore<TUser, TRole, TContext, TKey> : UserStore<TUser, TRole, TContext, TKey, IdentityUserRole<TKey>, IdentityUserLogin<TKey>, IdentityUserToken<TKey>>
    ...
    public class UserStore<TUser, TRole, TContext, TKey, TUserRole, TUserLogin, TUserToken> :
        UserStoreBase<TUser, TRole, TKey, TUserRole, TUserLogin, TUserToken>
        where TUser : IdentityUser<TKey>
        where TRole : IdentityRole<TKey>
        where TContext : DbContext
        where TKey : IEquatable<TKey>
